      ...
      {confirmed ? (
        <div>
          <div className="form-div">
            <Input addonBefore={"Stake"} suffix="VTT" value="337.33" disabled />
          </div>
        ...
        <div>
          <div className="form-div">
            <Input addonBefore={"Stake"} suffix="VTT" />
          </div>
          <div className="stat-box">
            <div className="stat-row">
              <div className="stat-left">Pool Share</div>
        ...
        <div>
          ...
          <div className="card-button">
            <Button type="primary" onClick={() => setOpen(true)}>Start staking</Button>
          </div>
        </div>
      )}
    </Card>
